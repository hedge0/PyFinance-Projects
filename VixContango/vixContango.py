...
vixFrontData = quandl.get(
    'CHRIS/CBOE_VX1', trim_start=startDate, trim_end=endDate, authtoken=apiKey)
vixFront = vixFrontData["Settle"]
vixSecondData = quandl.get(
    'CHRIS/CBOE_VX2', trim_start=startDate, trim_end=endDate, authtoken=apiKey)
